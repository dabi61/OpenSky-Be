...
namespace BE_OPENSKY.Migrations
{
    ...
    [Migration("20250926041410_RemoveMaxUsageAndAddIsDeletedToVoucher")]
    partial class RemoveMaxUsageAndAddIsDeletedToVoucher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BE_OPENSKY.Models.BillDetail", b =>
                {
                    ...
                    b.HasIndex("RoomID", "ScheduleID");

                    b.ToTable("BillDetails");
                });

            modelBuilder.Entity("BE_OPENSKY.Models.Booking", b =>
                {
                    b.Property<Guid>("BookingID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BE_OPENSKY.Models.Bill", b =>
                {
                    b.HasOne("BE_OPENSKY.Models.Booking", "Booking")
                        .WithOne("Bill")
                        .HasForeignKey("BE_OPENSKY.Models.Bill", "BookingID")
